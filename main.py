...
#Filling in the Google Form using Selenium
...
for n in range(len(all_links)):
    ...
    driver.get("https://docs.google.com/forms/d/e/1FAIpQLSeWRZRI3Kjx7IQ7IB-dO-QMpxwtN0iPLM43IPGqtyMWPk4eMg/viewform?usp=header")
    time.sleep(2)
